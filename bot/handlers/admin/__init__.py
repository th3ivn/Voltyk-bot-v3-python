...
from bot.handlers.admin.button_emoji import router as button_emoji_router
...
router.include_router(button_emoji_router)
router.include_router(pause_router)
router.include_router(admin_router_r)
router.include_router(database_router)
router.include_router(chart_settings_router)
