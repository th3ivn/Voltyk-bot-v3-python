...
class User(Base):
    ...
    last_hash: Mapped[str | None] = mapped_column(String(128))
    today_snapshot_hash: Mapped[str | None] = mapped_column(String(128))
    tomorrow_snapshot_hash: Mapped[str | None] = mapped_column(String(128))
    tomorrow_published_date: Mapped[str | None] = mapped_column(String(32))
...
class UserPowerState(Base):
    ...
    pending_state_time: Mapped[str | None] = mapped_column(String(64))
