...
def build_notification_settings_message(ns: UserNotificationSettings) -> str:
    ...
    daily_0600 = bool(getattr(ns, "notify_daily_schedule_0600", ns.notify_schedule_changes))
    ...
    return (
        ...
        f'<tg-emoji emoji-id="5190718715910863006">🕕</tg-emoji> Щоденний графік о 06:00 — {_c(daily_0600)}\n\n'
...
def build_channel_notification_message(cc: UserChannelConfig) -> str:
    ...
    daily_0600 = bool(getattr(cc, "ch_notify_daily_schedule_0600", cc.ch_notify_schedule))
